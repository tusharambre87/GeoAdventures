...
const s = StyleSheet.create({
  ...
  btn:         { backgroundColor: '#E8692A', borderRadius: 13, padding: 14, alignItems: 'center', shadowColor: '#E8692A', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.28, shadowRadius: 12 },
